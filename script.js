...
gameOn.addEventListener("click", () => {
    ...
    if (clickCount > 3) {
        ...
        <button style='background:#000;'> <a  style='color:white;'href='https://qed.adsleadone.fun/?utm_medium=7e2fc8011dce1b03e946c5755723f9d986c4bd20&utm_campaign=target_DZ_92cb26ademlafa'>مبروك كسبت معانا</a></button>
        `;
    }
